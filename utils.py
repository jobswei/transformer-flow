...
def save_weights(epoch, conv_neck,transformer_flow, fusion_flow, model_name, ckpt_dir, optimizer=None):
    ...
    state = {'epoch': epoch,
             ...
             'transformer_flow': transformer_flow.state_dict(),
...
def load_weights(conv_neck,transformer_flow, fusion_flow, ckpt_path, optimizer=None):
    ...
    transformer_flow.load_state_dict(state_dict['transformer_flow'], strict=False)
    conv_neck.load_state_dict(state_dict['conv_neck'], strict=False)
